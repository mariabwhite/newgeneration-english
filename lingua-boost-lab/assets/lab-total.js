...
(function(){
  ...
  function injectBlock(){
    ...
    sec.innerHTML = ''
      + '<div style="background:rgba(251,191,36,.08);border:1px solid rgba(251,191,36,.32);border-radius:14px;padding:18px 22px;text-align:center;color:var(--text,#f3eee5)">'
      +   '<div style="font-family:monospace;font-size:.78rem;letter-spacing:.18em;text-transform:uppercase;color:#fbbf24;font-weight:800;margin-bottom:10px">Lesson score · total</div>'
      ...
      +     '<div style="font-family:monospace;font-size:.72rem;letter-spacing:.16em;text-transform:uppercase;color:rgba(251,191,36,.78);font-weight:800;margin-bottom:6px">Band score</div>'
      ...
      +   '</div>'
      +   '<div style="background:rgba(251,191,36,.08);border:1px solid rgba(251,191,36,.32);border-radius:10px;padding:12px 16px;text-align:center;color:var(--text,#f3eee5)">'
      +     '<div style="font-family:monospace;font-size:.72rem;letter-spacing:.16em;text-transform:uppercase;color:#fbbf24;font-weight:800;margin-bottom:6px">CEFR level</div>'
      +     '<div style="font-weight:900;font-size:1.6rem;color:#fbbf24;line-height:1"><span id="lab-cefr-level">—</span></div>'
