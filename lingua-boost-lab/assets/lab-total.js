...
(function(){
  ...
  function injectBlock(){
    ...
    sec.innerHTML = ''
      + '<div style="background:rgba(46,125,50,.10);border:1px solid rgba(46,125,50,.4);border-radius:14px;padding:18px 22px;text-align:center">'
      +   '<div style="font-family:monospace;font-size:.78rem;letter-spacing:.18em;text-transform:uppercase;color:#2E7D32;font-weight:800;margin-bottom:10px">Lesson score · total</div>'
      +   '<div style="font-weight:900;font-size:2.4rem;color:#0a1c2e;line-height:1"><span id="lab-total-val">0</span><span style="color:#888;font-size:1.4rem;font-weight:700"> / <span id="lab-total-max">0</span></span></div>'
      +   '<div style="font-family:monospace;font-size:.74rem;color:#888;margin-top:6px;letter-spacing:.1em">auto-scored · saved in this browser</div>'
      + '</div>'
      + '<div style="margin-top:12px;display:grid;grid-template-columns:1fr 1fr;gap:12px">'
      +   '<div style="background:#fff;border:1px solid #eee;border-radius:10px;padding:12px 16px;text-align:center">'
      +     '<div style="font-family:monospace;font-size:.72rem;letter-spacing:.16em;text-transform:uppercase;color:#666;font-weight:800;margin-bottom:6px">Band score</div>'
      +     '<div style="font-weight:900;font-size:1.6rem;color:#0a1c2e;line-height:1"><span id="lab-cefr-band">—</span></div>'
      +     '<div style="font-family:monospace;font-size:.66rem;color:#999;margin-top:4px">1–6 scale</div>'
      +   '</div>'
      +   '<div style="background:rgba(46,125,50,.10);border:1px solid rgba(46,125,50,.4);border-radius:10px;padding:12px 16px;text-align:center">'
      +     '<div style="font-family:monospace;font-size:.72rem;letter-spacing:.16em;text-transform:uppercase;color:#2E7D32;font-weight:800;margin-bottom:6px">CEFR level</div>'
      +     '<div style="font-weight:900;font-size:1.6rem;color:#2E7D32;line-height:1"><span id="lab-cefr-level">—</span></div>'
      +     '<div style="font-family:monospace;font-size:.66rem;color:#999;margin-top:4px">auto-derived</div>'
      +   '</div>'
      + '</div>';
