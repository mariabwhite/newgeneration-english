...
(function(){
  ...
  function injectStyle(){
    ...
    s.textContent = ''+
      ...
      '.topbar .brand-mark::after,.friendly-topbar .brand-mark::after,.lab-topbar .brand-mark::after,.cmdbar .brand-mark::after,.cmdbar .cb-mark::after,.canon-l-topbar .brand-mark::after,.canon-l-topbar .canon-l-mark::after,.friendly-topbar .brand-logo-mark::after{content:"" !important;display:block !important;position:absolute !important;right:0 !important;top:0 !important;bottom:auto !important;width:12px !important;height:12px !important;border:0 !important;border-radius:0 !important;background:#fff !important;clip-path:polygon(100% 0,0 0,100% 100%) !important;z-index:2 !important}'+
      'body[class] .canon-l-topbar .canon-l-mark::after,body[class] .canon-l-topbar .brand-mark::after,body[class] .topbar .brand-mark::after,body[class] .friendly-topbar .brand-mark::after,body[class] .lab-topbar .brand-mark::after,body[class] .cmdbar .brand-mark::after,body[class] .cmdbar .cb-mark::after,body[class] .friendly-topbar .brand-logo-mark::after{background:#fff !important}'+
