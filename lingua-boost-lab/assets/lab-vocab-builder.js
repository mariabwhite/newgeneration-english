...
(function(){
  ...
  function injectStyle(){
    ...
    s.textContent = ''+
      ...
      '.topbar .brand-mark,.friendly-topbar .brand-mark,.lab-topbar .brand-mark,.cmdbar .brand-mark,.cmdbar .cb-mark,.canon-l-topbar .brand-mark,.canon-l-topbar .canon-l-mark,.friendly-topbar .brand-logo-mark{position:relative !important;overflow:visible !important;display:grid !important;place-items:center !important;width:40px !important;height:40px !important;min-width:40px !important;border:0 !important;border-radius:8px !important;border-top-right-radius:0 !important;background:var(--accent,var(--brand,var(--lb-link-hover,#ff690a))) !important;color:#fff !important;clip-path:polygon(0 0,calc(100% - 12px) 0,100% 12px,100% 100%,0 100%) !important}'+
