...
(function(){
  ...
  function injectStyle(){
    ...
    s.textContent = ''+
      ...
      /* v50 2026-07-08: canon-l-mark полностью убран из унификации — у него свой HTML (SVG иконка или пусто), не надо ломать через ::before/::after. Оставляем ТОЛЬКО старую систему .brand-mark/.brand-logo-mark/.cb-mark где нужно перерисовать. */
